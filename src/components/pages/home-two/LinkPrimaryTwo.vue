...
<template>
  <div
    class="d-flex justify-content-between align-items-center link-primary-two"
    :class="className"
  >
    <div class="link-primary-two__content">
      <span class="link-primary-two__content__text textM">
        {{ linkText }}
      </span>
    </div>
    <router-link :to="link" class="link-primary-two__image">
      <svg
