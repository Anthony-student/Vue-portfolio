...
<template>
    <nav
        class="d-flex justify-content-between align-items-center link-primary"
        :class="className"
    >
        <p class="link-primary__content__text textM">{{ linkText }}</p>
        <router-link :to="link" class="link-primary__image">
            <svg
...
[theme="custom-light"] .link-primary__image svg:hover {
    stroke: var(--secondary-color);
}
</style>
